    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i=0; i< earthquakeArray.length(); i++) {
                JSONObject currentEarthquakeArray = earthquakeArray.getJSONObject(i);
                JSONObject properties = currentEarthquakeArray.getJSONObject("properties");
                ...
                Earthquake earthquake = new Earthquake(magnitude, location, time, date);
